...
export default function MindSynapse() {
  ...
  const resetIdleTimer = useCallback(() => {
    ...
    setMascotState(prev => prev === 'sleep' ? 'idle' : prev);
    ...
    <SafeAreaView style={styles.container}>
      ...
      {loading ? (
        ...
        <>
          ...
          {step === 2 && !errorMsg && (
            <View style={[styles.inputContainer, { padding: 0, maxHeight: height * 0.8, overflow: 'hidden' }]}>
              <ScrollView
                style={{ width: '100%' }}
              ...
              >
                ...
                {aiQuestions.map((q, i) => (
                  <View key={i} style={styles.qaBlock}>
                    ...
                    <TextInput
                      style={[styles.inputSmall, { minHeight: 60 }]}
                ...
                <TouchableOpacity style={[styles.button, { marginTop: 10, marginBottom: 10 }]} onPress={generateMindMap}>
