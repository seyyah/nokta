...
// 2. Force Metro to resolve packages from the app's node_modules first
config.resolver.nodeModulesPaths = [
  path.resolve(projectRoot, 'node_modules'),
];

// 3. Alias peer dependencies to the host app's node_modules to avoid duplicates/resolution issues
