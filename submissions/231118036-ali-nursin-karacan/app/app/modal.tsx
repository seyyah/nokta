...
<head>
  ...
  <style>
    body { margin: 0; background: #e5e5ea; overflow: hidden; display: flex; justify-content: center; align-items: center; width: 100vw; height: 100vh; }
    canvas { width: 100%; height: 100%; outline: none; }
  </style>
</head>
<body>
<script>
  // Forward errors to React Native
        ...
        >
          <View style={styles.videoPlaceholder}>
            {Platform.OS === 'web' ? (
              ...
              <WebView 
                ref={webViewRef}
                source={{ html: AVATAR_HTML, baseUrl: 'https://cdnjs.cloudflare.com' }} 
                originWhitelist={['*']}
                ...
                onMessage={(event) => {
                  try {
                    ...
                    if (data && data.type === 'error') {
                      console.error('WebView 3D Avatar Error:', data.message);
                    }
                  } catch {
