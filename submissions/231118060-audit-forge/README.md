...
Demo video linki: https://drive.google.com/file/d/231118060-nokta-audit-forge-demo/view?usp=sharing
...
- Local toolchain: `npm run typecheck`, `npx expo install --check`, `rg`, local score script ve Android build denemesi.
