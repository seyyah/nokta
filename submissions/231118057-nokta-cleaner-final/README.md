...
**Hafta 3 Track:** 1 (Voice viz akıcılığı + lipsync senkronu)
...
**Track 1 minimum-impl:** stuck **manuel** tetiklenir. Auto-stuck detection heuristic (Track 3) bilinçli olarak yapılmadı.
...
Hafta 2'de Track B (yaratıcılık) seçildi: müşteri ↔ geliştirici aynı kişi kompozisyonu. Hafta 3'te Track 1 (sade ama kusursuz) tercih edildi çünkü:
...
- Track 2 (multi-persona) iki tane "junior-sen / senior-sen" varyantı için ek `.glb` ve UX yükü getiriyor — kapsama oranı yüksek ama gösterim değeri Track 1'in altında.
- Track 3 (auto-stuck heuristic + auto-call) güzel ama "yapay zekanın canının sıkılıp insanı çağırması" gibi bir bar gerektirir; submission scope'unda bilinçli kısıtlama.
...
| 5 | 2026-05-24 | **Hafta 3 Track 1** seçildi | Phase A'nın görsel/lipsync kalitesi puanlamayı dominate ediyor; sade ama kusursuz çizgisi |
...
### Hafta 2 (Track B)
- [x] `README.md` ilk satırı (artık `Track: 1`, Hafta 3 üzerine yazıldı)
- [x] `app/` — Expo projesi
...
- [x] PERSONAS.md (gereksiz — Track 1 seçildi)
