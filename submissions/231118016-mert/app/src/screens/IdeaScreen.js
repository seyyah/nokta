  ...
  return (
    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        {/* Yeni Katmanlar */}
        <View style={styles.newLayersContainer}>
          <Text style={styles.newLayersTitle}>Yeni Özellikler</Text>
          <View style={styles.newLayersRow}>
            <TouchableOpacity
              style={styles.layerBtn}
              onPress={() => navigation.navigate('VoiceScreen')}
            >
              <Text style={styles.layerBtnIcon}>🎙️</Text>
              <Text style={styles.layerBtnText}>Ses{'\n'}Görsel</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.layerBtn}
            ...
            >
              ...
              <Text style={styles.layerBtnText}>Avatar{'\n'}Lipsync</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.layerBtn, styles.layerBtnExpert]}
              onPress={() => navigation.navigate('ExpertBridgeScreen')}
            >
              <Text style={styles.layerBtnIcon}>📞</Text>
              <Text style={styles.layerBtnText}>Uzman{'\n'}Köprüsü</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
