        ...
        <ScrollView style={containerStyle} contentContainerStyle={styles.contentContainer}>
            ...
            <View style={styles.section}>
                ...
                <TouchableOpacity
                    ...
                    onPress={() => Alert.alert('Kişisel Bilgiler', 'Bu özellik yakında aktif olacaktır.')}
                >
                ...
                <TouchableOpacity
                    style={[styles.settingItem, isDarkMode && { backgroundColor: '#1E1E1E', borderColor: '#333' }]}
                    onPress={() => Alert.alert('Güvenlik', 'Şifre ve güvenlik ayarları yakında gelecektir.')}
                >
                    <View style={[styles.settingIcon, isDarkMode && { backgroundColor: '#2D3748' }]}>
                ...
                <TouchableOpacity
                    style={[styles.settingItem, isDarkMode && { backgroundColor: '#1E1E1E', borderColor: '#333' }]}
                    onPress={() => Alert.alert('Gizlilik', 'Gizlilik tercihleri yakında gelecektir.')}
                >
                    <View style={[styles.settingIcon, isDarkMode && { backgroundColor: '#2D3748' }]}>
            ...
            <View style={styles.section}>
                ...
                <TouchableOpacity
                    style={[styles.settingItem, isDarkMode && { backgroundColor: '#1E1E1E', borderColor: '#333' }]}
                    onPress={() => Alert.alert('Bildirimler', 'Bildirim ayarları yakında gelecektir.')}
                >
                    <View style={[styles.settingIcon, isDarkMode && { backgroundColor: '#333' }]}>
            ...
            <View style={styles.section}>
                ...
                <TouchableOpacity
                    style={[styles.settingItem, isDarkMode && { backgroundColor: '#1E1E1E', borderColor: '#333' }]}
                    onPress={() => Alert.alert('Yardım', 'Destek merkezi yakında aktif olacaktır.')}
                >
                    <View style={[styles.settingIcon, isDarkMode && { backgroundColor: '#333' }]}>
