...
* **LOCATE:** `submissions/231118054/app/app/onboarding.tsx` dosyasındaki `title` stili (`line 104-115`) hedeflendi.
...
* **COMMIT:** `git add submissions/231118054/app/app/onboarding.tsx` ve `git commit -m "[FORGE: onboarding] Onboarding title font size and horizontal padding increased — 5kg"` çalıştırıldı.  
...
* **LOCATE:** `submissions/231118054/app/app/spec.tsx` dosyası hedeflendi.
...
* **COMMIT:** `git add submissions/231118054/app/app/spec.tsx` ve `git commit -m "[FORGE: spec] Spec sharing and card headers styling added — 12kg"` çalıştırıldı.  
...
* **LOCATE:** `submissions/231118054/app/app/(tabs)/index.tsx` dosyası hedeflendi.
...
* **LOCATE:** `submissions/231118054/app/app/(tabs)/index.tsx` dosyası ve stylesheet alanları hedeflendi.
...
* **TEST:** `npx tsc --noEmit` komutu çalıştırıldı.
* **VERIFY:** TypeScript derlemesi başarıyla sıfır hata ile tamamlandı.
* **COMMIT:** `git add submissions/231118054/app/app/(tabs)/index.tsx` ve `git commit -m "[FORGE: index] Onboarding guide navigation helper button added — 8kg"` çalıştırıldı.  
