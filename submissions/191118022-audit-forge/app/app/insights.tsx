...
export default function InsightsScreen() {
  return (
    <ScreenScaffold
      ...
      subtitle="This screen exists mostly to keep the host app above the three-screen minimum while giving testers a different layout to audit if they want a fourth report."
    >
