  ...
  return (
    <View style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={styles.cta} onPress={() => router.push('/assistant')}>
          <Text style={styles.ctaText}>Sesli Nokta Asistanını Başlat</Text>
        </TouchableOpacity>

        <TouchableOpacity style={[styles.allIdeas, styles.secondaryLink]} onPress={() => router.push('/ideas')}>
...
const styles = StyleSheet.create({
  ...
  secondaryLink: { borderWidth: 1, borderColor: '#2a2a2a', borderRadius: 10, marginTop: 4 },
